...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t3019) {
      cljs.core.t3019 = {};
      cljs.core.t3019 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta3020 = c;
      ...
      cljs.core.t3019.cljs$lang$type = !0;
      cljs.core.t3019.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t3019")
      };
      cljs.core.t3019.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t3019")
      };
      var c = cljs.core.t3019.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t3019.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t3019.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3019.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3020
      };
      cljs.core.t3019.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t3019(this.meta, this.f, b)
      }
    }
    return new cljs.core.t3019(b, a, null)
  }(), b)
};
...
var pat = {prog_name:"Patient Waiting Time Simulator", version:"0.1"};
pat.title = [cljs.core.str(pat.prog_name), cljs.core.str(" "), cljs.core.str(pat.version)].join("");
pat.find_span = function(a, b, c, d) {
  for(;;) {
    if(0 < a) {
      var e = b.call(null), f = a - e, g = f, h = c + 1, d = cljs.core.conj.call(null, d, cljs.core.PersistentVector.fromArray([-c, 0 > f ? a : e], !0)), a = g, c = h
    }else {
      return cljs.core.reverse.call(null, d)
    }
  }
};
pat.rolling_average = function(a, b, c) {
  var b = cljs.core.filter.call(null, function(a) {
    return a > c
  }, cljs.core.filter.call(null, cljs.core.pos_QMARK_, b)), d = cljs.core.count.call(null, b), b = 0 === d ? a : cljs.core.reduce.call(null, cljs.core._PLUS_, b) / d;
  return 0 === a ? b : (a + b) / 2
};
pat.avqtime = function(a, b) {
  return cljs.core.reduce.call(null, function(a, d) {
    return pat.rolling_average.call(null, a, d, b)
  }, 0, a)
};
pat.get_empty_count = function(a) {
  return cljs.core.reduce.call(null, cljs.core._PLUS_, function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        var e = cljs.core.seq.call(null, a);
        return e ? (e = cljs.core.first.call(null, e), cljs.core.cons.call(null, cljs.core.count.call(null, cljs.core.filter.call(null, cljs.core.neg_QMARK_, e)), c.call(null, cljs.core.rest.call(null, a)))) : null
      }
    }, null)
  }.call(null, a))
};
pat.start = function() {
  try {
    var a = gui.get_int.call(null, "\ufdd0:nperiods"), b = gui.get_int.call(null, "\ufdd0:sla"), c = gui.get_int.call(null, "\ufdd0:nreferrals"), d = gui.get_int.call(null, "\ufdd0:nqueued"), e = gui.get_checked.call(null, "\ufdd0:normal"), f = simul.gen_periods.call(null, cljs.core.PersistentVector.EMPTY, cljs.core.deref.call(null, gui.slot_vec)), g = cljs.core.truth_(e) ? function() {
      return simul.grand.call(null, c)
    } : cljs.core.constantly.call(null, c), h = simul.mkqueue.call(null);
    gui.clear.call(null);
    for(var i = cljs.core.seq.call(null, pat.find_span.call(null, d, g, 1, cljs.core.PersistentVector.EMPTY));;) {
      if(i) {
        var j = cljs.core.first.call(null, i), l = cljs.core.nth.call(null, j, 0, null), m = cljs.core.nth.call(null, j, 1, null);
        simul.add_requests.call(null, h, l, m);
        i = cljs.core.next.call(null, i)
      }else {
        break
      }
    }
    var k = simul.run_simul.call(null, h, a, f, g), n = cljs.core.apply.call(null, cljs.core._PLUS_, cljs.core.map.call(null, function(a) {
      return cljs.core.count.call(null, cljs.core.filter.call(null, function(a) {
        return a > b
      }, a))
    }, k)), p = pat.avqtime.call(null, k, b), q = pat.get_empty_count.call(null, k);
    gui.draw_graph.call(null, k);
    gui.set_value.call(null, "\ufdd0:nbreached", "" + cljs.core.str(n));
    gui.set_value.call(null, "\ufdd0:avqtime", cljs.core.format.call(null, "%.1f", p));
    return gui.set_value.call(null, "\ufdd0:unusedslots", "" + cljs.core.str(q))
  }catch(r) {
    if(cljs.core.instance_QMARK_.call(null, Error, r)) {
      return alert([cljs.core.str("ERROR: "), cljs.core.str(r)].join(""))
    }
    throw r;
  }
};
pat.set_slots = function(a) {
  cljs.core.truth_(a) && gui.init_slots.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray([0, gui.get_int.call(null, "\ufdd0:navslots")], !0)], !0));
  var a = simul.gen_periods.call(null, cljs.core.PersistentVector.EMPTY, cljs.core.deref.call(null, gui.slot_vec)), b = gui.get_int.call(null, "\ufdd0:nperiods"), a = cljs.core.take.call(null, b, cljs.core.map.call(null, function(a) {
    return cljs.core.repeat.call(null, a, -1)
  }, a));
  return gui.draw_graph.call(null, a)
};
pat.setup = function() {
  for(var a = cljs.core.seq.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\ufdd0:nperiods", "52"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:nreferrals", "22"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:nqueued", "0"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:nslots", "30"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:sla", "10"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:navslots", "22"], !0)], !0));;) {
    if(a) {
      var b = cljs.core.first.call(null, a), c = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null);
      gui.set_value.call(null, c, b);
      a = cljs.core.next.call(null, a)
    }else {
      break
    }
  }
  gui.init_slots.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray([0, gui.get_int.call(null, "\ufdd0:navslots")], !0)], !0));
  return cljs.core.truth_(gui.canvas_available.call(null)) ? gui.set_mouse_refresh.call(null, pat.set_slots) : document.write("<h1>Unsupported Browser</h1> <p>Please consider upgrading to the latest version of Chrome, Firefox, Opera, Safari or IE.</p>")
};
var simul = {};
simul.span = cljs.core.atom.call(null, cljs.core.vector.call(null));
simul.grand = function(a) {
  var b = Math.random(), c = Math.random(), b = Math.sqrt(-2 * Math.log(b)) * Math.cos(2 * Math.PI * c);
  return cljs.core.int$.call(null, 8.333 * b + a)
};
simul.mkqueue = function() {
  return cljs.core.atom.call(null, cljs.core.PersistentQueue.EMPTY)
};
simul.enqueue = function(a, b) {
  cljs.core.swap_BANG_.call(null, a, cljs.core.conj, b);
  return a
};
simul.peek_queue = function(a) {
  return cljs.core.peek.call(null, cljs.core.deref.call(null, a))
};
simul.dequeue = function(a) {
  var b = simul.peek_queue.call(null, a);
  return cljs.core.truth_(b) ? (cljs.core.swap_BANG_.call(null, a, cljs.core.pop), b) : null
};
simul.add_period = function(a, b) {
  return cljs.core.swap_BANG_.call(null, a, cljs.core.conj, b)
};
simul.vref = function(a, b) {
  return cljs.core.nth.call(null, cljs.core.deref.call(null, a), b)
};
simul.request = function() {
  return null
};
simul.add_requests = function(a, b, c) {
  for(;;) {
    if(0 < c) {
      a = simul.enqueue.call(null, a, b), c -= 1
    }else {
      return a
    }
  }
};
simul.gen_periods = function(a, b) {
  for(;;) {
    var c = cljs.core.first.call(null, b), d = cljs.core.next.call(null, b);
    if(d) {
      a = c = cljs.core.concat.call(null, a, cljs.core.repeat.call(null, cljs.core.ffirst.call(null, d) - cljs.core.first.call(null, c), cljs.core.second.call(null, c))), b = d
    }else {
      return cljs.core.concat.call(null, a, cljs.core.repeat.call(null, cljs.core.second.call(null, c)))
    }
  }
};
simul.service_reqs = function(a, b, c) {
  return cljs.core.doall.call(null, function e(c) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        var g = cljs.core.seq.call(null, c);
        return g ? (cljs.core.first.call(null, g), cljs.core.cons.call(null, function() {
          var c = simul.dequeue.call(null, a);
          return cljs.core.truth_(c) ? b - c : -1
        }(), e.call(null, cljs.core.rest.call(null, c)))) : null
      }
    }, null)
  }.call(null, cljs.core.range.call(null, c)))
};
simul.run_simul = function(a, b, c, d) {
  return function f(b) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        ...
        if(h) {
          ...
          return cljs.core.cons.call(null, function() {
            simul.add_requests.call(null, a, i, d.call(null));
            return simul.service_reqs.call(null, a, i, cljs.core.nth.call(null, c, i))
          }(), f.call(null, cljs.core.rest.call(null, b)))
        }
        return null
      }
    }, null)
...
gui.stride = 20;
gui.colorvec = cljs.core.PersistentVector.fromArray(["#88FF88", "#FF8888", "#6666FF"], !0);
gui.canvas_available = function() {
  return window.CanvasRenderingContext2D
};
gui.init_slots = function(a) {
  return cljs.core.reset_BANG_.call(null, gui.slot_vec, a)
};
gui.get_value = function(a) {
  return document.getElementById(cljs.core.name.call(null, a)).value
};
gui.set_value = function(a, b) {
  return document.getElementById(cljs.core.name.call(null, a)).value = b
};
gui.get_checked = function(a) {
  return document.getElementById(cljs.core.name.call(null, a)).checked
};
gui.get_canvas = function() {
  return document.getElementById("patCanvas")
};
gui.get_context = function() {
  return gui.get_canvas.call(null).getContext("2d")
};
gui.get_int = function(a) {
  try {
    return parseInt(gui.get_value.call(null, a))
  }catch(b) {
...
gui.colour_map = function(a, b) {
  return a > b ? 1 : 0 > a ? 2 : a <= b ? 0 : null
};
gui.draw_symbol = function(a, b, c, d, e) {
  a.fillStyle = e;
  return a.fillRect(b, c, d, d)
};
gui.draw_column = function(a, b, c, d, e, f, g, h) {
  return cljs.core.doall.call(null, cljs.core.map.call(null, function(c, e) {
    return gui.draw_symbol.call(null, a, (b + 1) * f, e, d, cljs.core.nth.call(null, gui.colorvec, gui.colour_map.call(null, c, h)))
  }, c, cljs.core.range.call(null, g - 2.5 * f, 0, -f)))
};
gui.merge_slots = function(a, b) {
  for(;;) {
    var c = cljs.core.first.call(null, a), d = cljs.core.second.call(null, a);
    if(cljs.core.empty_QMARK_.call(null, a)) {
      return b
    }
    cljs.core._EQ_.call(null, cljs.core.second.call(null, c), cljs.core.second.call(null, d)) ? (c = cljs.core.cons.call(null, c, cljs.core.rest.call(null, cljs.core.rest.call(null, a))), d = b, a = c, b = d) : (d = cljs.core.rest.call(null, a), c = cljs.core.conj.call(null, b, c), a = d, b = c)
  }
};
gui.handle_slots = function(a) {
  var b = cljs.core.vec.call(null, cljs.core.filter.call(null, function(b) {
    return cljs.core.not_EQ_.call(null, cljs.core.first.call(null, b), cljs.core.first.call(null, a))
  }, cljs.core.deref.call(null, gui.slot_vec)));
  return cljs.core.reset_BANG_.call(null, gui.slot_vec, gui.merge_slots.call(null, cljs.core.vec.call(null, cljs.core.sort.call(null, function(a, b) {
    return cljs.core.first.call(null, a) < cljs.core.first.call(null, b)
  }, cljs.core.into.call(null, b, cljs.core.PersistentVector.fromArray([a], !0)))), cljs.core.PersistentVector.EMPTY))
};
gui.draw_axes = function(a, b, c, d, e) {
  a.fillStyle = "#00000";
  for(var f = cljs.core.seq.call(null, cljs.core.range.call(null, d));;) {
    if(f) {
      var g = cljs.core.first.call(null, f);
      a.fillText("" + cljs.core.str(g), (g + 1) * e, b - e - 2);
  ...
  cljs.core.doall.call(null, cljs.core.map.call(null, function(b, c) {
    return a.fillText(cljs.core.format.call(null, "%2d", c), 1, b)
  }, cljs.core.range.call(null, b - 2 * e, 0, -e), cljs.core.range.call(null, 1, c + 1)));
  for(c = cljs.core.seq.call(null, cljs.core.range.call(null, 1 * e, (d + 1) * e, e));;) {
    if(c) {
      d = cljs.core.first.call(null, c);
      for(f = cljs.core.seq.call(null, cljs.core.range.call(null, b - 2 * e, 0, -e));;) {
        if(f) {
          g = cljs.core.first.call(null, f), a.fillText("+", d, g), f = cljs.core.next.call(null, f)
        }else {
          break
        }
      }
...
gui.clear = function() {
  var a = gui.get_canvas.call(null), b = a.width, a = a.height;
  return gui.get_context.call(null).clearRect(0, 0, b, a)
};
gui.draw_graph = function(a) {
  gui.clear.call(null);
  var b = gui.get_int.call(null, "\ufdd0:nslots"), c = (b + 2) * gui.stride, d = gui.get_int.call(null, "\ufdd0:sla"), e = gui.get_int.call(null, "\ufdd0:nperiods"), f = gui.get_context.call(null), g = cljs.core.int$.call(null, gui.stride / 2);
  gui.get_canvas.call(null).height = c;
  gui.get_canvas.call(null).width = (e + 2) * gui.stride;
  gui.draw_axes.call(null, f, c, b, e, gui.stride);
  for(b = cljs.core.seq.call(null, cljs.core.range.call(null, e));;) {
    if(b) {
      e = cljs.core.first.call(null, b), gui.draw_column.call(null, f, e, cljs.core.nth.call(null, a, e), g, g, gui.stride, c, d), b = cljs.core.next.call(null, b)
    }else {
      return null
    }
  }
};
gui.event_coords = function(a) {
  var b = a.offsetX, c = a.offsetY;
  return cljs.core.truth_(cljs.core.truth_(b) ? c : b) ? cljs.core.PersistentVector.fromArray([b, c], !0) : cljs.core.PersistentVector.fromArray([a.layerX, a.layerY], !0)
};
gui.mouse_click = function(a) {
  var a = gui.event_coords.call(null, a), b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nth.call(null, a, 1, null), c = gui.get_canvas.call(null).height, b = cljs.core.int$.call(null, b / gui.stride) - 1, c = cljs.core.int$.call(null, (c - a) / gui.stride) - 1;
  cljs.core.int$.call(null, a / gui.stride);
  gui.handle_slots.call(null, cljs.core.PersistentVector.fromArray([b, c], !0));
  return cljs.core.truth_(cljs.core.deref.call(null, gui.refresh_fn)) ? cljs.core.deref.call(null, gui.refresh_fn).call(null) : null
};
gui.set_mouse_refresh = function(a) {
  return cljs.core.reset_BANG_.call(null, gui.refresh_fn, a)
};
