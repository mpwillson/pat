...
goog.provide("pat.simul");
goog.require("cljs.core");
pat.simul.span = cljs.core.atom.call(null, cljs.core.vector.call(null));
pat.simul.grand = function grand(mean) {
  var u1 = Math.random();
  var u2 = Math.random();
  var n = Math.sqrt(-2 * Math.log(u1)) * Math.cos(2 * Math.PI * u2);
  return cljs.core.int$.call(null, 8.333 * n + mean)
};
pat.simul.mkqueue = function mkqueue() {
  return cljs.core.atom.call(null, cljs.core.PersistentQueue.EMPTY)
};
pat.simul.enqueue = function enqueue(q, elt) {
  cljs.core.swap_BANG_.call(null, q, cljs.core.conj, elt);
  return q
};
pat.simul.peek_queue = function peek_queue(q) {
  return cljs.core.peek.call(null, cljs.core.deref.call(null, q))
};
pat.simul.dequeue = function dequeue(q) {
  var temp__4090__auto__ = pat.simul.peek_queue.call(null, q);
  if(cljs.core.truth_(temp__4090__auto__)) {
...
pat.simul.add_period = function add_period(v, elt) {
  return cljs.core.swap_BANG_.call(null, v, cljs.core.conj, elt)
};
pat.simul.vref = function vref(v, n) {
  return cljs.core.nth.call(null, cljs.core.deref.call(null, v), n)
};
pat.simul.request = function request(period) {
  return null
};
pat.simul.add_requests = function add_requests(q, period, nreqs) {
  while(true) {
    if(nreqs > 0) {
      var G__2936 = pat.simul.enqueue.call(null, q, period);
      var G__2937 = period;
      var G__2938 = nreqs - 1;
      q = G__2936;
      period = G__2937;
...
pat.simul.gen_periods = function gen_periods(p, period_defn) {
  while(true) {
    var current = cljs.core.first.call(null, period_defn);
    var next = cljs.core.next.call(null, period_defn);
    if(next) {
      var G__2939 = cljs.core.concat.call(null, p, cljs.core.repeat.call(null, cljs.core.ffirst.call(null, next) - cljs.core.first.call(null, current), cljs.core.second.call(null, current)));
      var G__2940 = next;
      p = G__2939;
      period_defn = G__2940;
      continue
...
pat.simul.service_reqs = function service_reqs(q, current, nserved) {
  return cljs.core.doall.call(null, function() {
    var iter__2611__auto__ = function iter__2943(s__2944) {
      return new cljs.core.LazySeq(null, false, function() {
        var s__2944__$1 = s__2944;
        while(true) {
          var temp__4092__auto__ = cljs.core.seq.call(null, s__2944__$1);
          if(temp__4092__auto__) {
            var xs__4579__auto__ = temp__4092__auto__;
            var n = cljs.core.first.call(null, xs__4579__auto__);
            return cljs.core.cons.call(null, function() {
              var started = pat.simul.dequeue.call(null, q);
              if(cljs.core.truth_(started)) {
                return current - started
              }else {
                return-1
              }
            }(), iter__2943.call(null, cljs.core.rest.call(null, s__2944__$1)))
          }else {
            return null
          }
          break
...
pat.simul.run_simul = function run_simul(q, nperiods, service_rates, arrival_rate_fn) {
  var iter__2611__auto__ = function iter__2947(s__2948) {
    return new cljs.core.LazySeq(null, false, function() {
      var s__2948__$1 = s__2948;
      while(true) {
        var temp__4092__auto__ = cljs.core.seq.call(null, s__2948__$1);
        if(temp__4092__auto__) {
          var xs__4579__auto__ = temp__4092__auto__;
          var n = cljs.core.first.call(null, xs__4579__auto__);
          return cljs.core.cons.call(null, function() {
            pat.simul.add_requests.call(null, q, n, arrival_rate_fn.call(null));
            return pat.simul.service_reqs.call(null, q, n, cljs.core.nth.call(null, service_rates, n))
          }(), iter__2947.call(null, cljs.core.rest.call(null, s__2948__$1)))
        }else {
          return null
        }
        break
...
goog.provide("pat.core");
goog.require("cljs.core");
pat.core.fill = function fill() {
  var c = document.getElementById("myCanvas");
  var width = c.width;
  var height = c.height;
  var ctx = c.getContext("2d");
  var colour = document.getElementById("colour").value;
  if(cljs.core._EQ_.call(null, colour, "")) {
  ...
  var G__4004_4006 = cljs.core.seq.call(null, cljs.core.range.call(null, 0, width, 20));
  while(true) {
    if(G__4004_4006) {
      var x_4007 = cljs.core.first.call(null, G__4004_4006);
      var G__4005_4008 = cljs.core.seq.call(null, cljs.core.range.call(null, 0, height, 20));
      while(true) {
        if(G__4005_4008) {
          var y_4009 = cljs.core.first.call(null, G__4005_4008);
          ctx.fillText("+", x_4007, y_4009);
          var G__4010 = cljs.core.next.call(null, G__4005_4008);
          G__4005_4008 = G__4010;
          continue
        }else {
        }
        break
      }
      var G__4011 = cljs.core.next.call(null, G__4004_4006);
      G__4004_4006 = G__4011;
      continue
    }else {
    }
    break
  }
  return alert([cljs.core.str("<p>"), cljs.core.str(colour), cljs.core.str("</p>")].join(""))
};
document.write("<p>Hello, clojurescript world!</p>");
goog.provide("gui");
goog.require("cljs.core");
...
gui.draw_axes = function draw_axes(ctx, h, nperiods, stride) {
  "000000".fillStyle = null;
  var G__5653_5656 = cljs.core.seq.call(null, cljs.core.range.call(null, nperiods));
  while(true) {
    if(G__5653_5656) {
      var n_5657 = cljs.core.first.call(null, G__5653_5656);
      ctx.fillText([cljs.core.str(n_5657)].join(""), (n_5657 + 1) * stride, h - stride / 2);
      var G__5658 = cljs.core.next.call(null, G__5653_5656);
      G__5653_5656 = G__5658;
      continue
    }else {
    }
    break
  }
  cljs.core.doall.call(null, cljs.core.map.call(null, function(p1__5649_SHARP_, p2__5648_SHARP_) {
    return ctx.fillText(cljs.core.format.call(null, "%2d", p2__5648_SHARP_), 1, p1__5649_SHARP_)
  }, cljs.core.range.call(null, h - stride - 10, 0, -stride), cljs.core.range.call(null, 1, nperiods + 1)));
  var G__5654 = cljs.core.seq.call(null, cljs.core.range.call(null, 1 * stride, (nperiods + 1) * stride, stride));
  while(true) {
    if(G__5654) {
      var x = cljs.core.first.call(null, G__5654);
      var G__5655_5659 = cljs.core.seq.call(null, cljs.core.range.call(null, h - (10 + stride), 0, -stride));
      while(true) {
        if(G__5655_5659) {
          var y_5660 = cljs.core.first.call(null, G__5655_5659);
          ctx.fillText("+", x, y_5660);
          var G__5661 = cljs.core.next.call(null, G__5655_5659);
          G__5655_5659 = G__5661;
          continue
        }else {
        }
        break
      }
      var G__5662 = cljs.core.next.call(null, G__5654);
      G__5654 = G__5662;
      continue
    }else {
      return null
...
gui.draw_graph = function draw_graph() {
  alert(gui.get_value.call(null, "\ufdd0:colour"));
  return gui.draw_axes.call(null, gui.get_context.call(null), 1E3, 52, 20)
};
